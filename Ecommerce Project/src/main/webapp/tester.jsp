	...
	<section>
		<form action="" style="padding-right: 1%; padding-left: 1%;">
			<div
				...
				class="card">
				<input onclick="addproductpageadmin.jsp"
					style="padding-right: 50%; padding-left: 45%;"
					class="btn btn-success" type="submit" value="Add Product"
					name="addproduct" id="addproduct"></input>
